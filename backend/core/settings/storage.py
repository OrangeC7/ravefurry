...
defaults = {
    ...
    "site_mode": "event",
    "maintenance_restart_song_interval": 20,
    "songs_since_maintenance_restart": 0,
    "silence_tail_skip_enabled": True,
    "silence_tail_threshold_db": -45.0,
    "silence_tail_min_seconds": 5.0,
    "silence_tail_padding_seconds": 2.0,
    "silence_tail_start_grace_seconds": 10.0,
    "song_transition_fade_seconds": 2.0,
